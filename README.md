...
## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet(('[https://raw.githubusercontent.com/shlexware/Orion/main/source](https://raw.githubusercontent.com/Nghiavndeptraivcc/Orion-nhu-cut/main/Orion.Source)')))()
```
